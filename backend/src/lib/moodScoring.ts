...
export interface MoodInput {
  ...
  productivity: number;
  /** Optional energy qualifier */
  energy?: 'low' | 'mid' | 'high';
}

export type MoodCategory = 'happy' | 'energetic' | 'calm' | 'stressed' | 'sad' | 'focused';
 ...
 */
export function computeMoodCategory(input: MoodInput): MoodCategory {
