...
import { type AffirmationType, getRandomAffirmation, type AffirmationEntry } from '@/lib/affirmations';
...
interface ToastContextValue {
  /** Fire an affirmation toast for a given trigger type */
  fireToast: (type: AffirmationType) => void;
  /** Current active toast (only one shown at a time) */
