...
import { MOOD_THEMES, MoodCategory } from '@/lib/moodTheme';
import { staggerContainerVariants, staggerItemVariants, DURATION, EASE } from '@/lib/animation';
...
const MOOD_OPTIONS: MoodCategory[] = [
  'happy',
  'energetic',
  'calm',
  'focused',
 ...
 */
export default function EmojiMoodSelector({
  selectedMood,
  onSelect,
          ...
          return (
            ...
            >
              ...
              <span
                ...
                style={{ color: isSelected ? theme.color : 'rgba(255,255,255,0.55)' }}
              >
                {theme.label}
              </span>
              ...
              {isSelected && (
                <motion.div
                  ...
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  transition={DURATION.FADE as never}
                />
              )}
            </motion.button>
          );
