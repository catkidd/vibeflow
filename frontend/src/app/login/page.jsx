...
export default function LoginPage() {
  ...
  return (
    <FocusFade
      moodColor={MOOD_THEMES.focused.color}
    ...
    >
      ...
      >
        ...
        <motion.div variants={staggerItemVariants} style={{ width: "100%" }}>
          <motion.button
            ...
            style={{
              ...
              border: "none",
              cursor: "pointer",
              boxShadow: MOOD_THEMES.focused.subtleGlow,
            }}
            whileHover={{
              scale: 1.02,
              boxShadow: MOOD_THEMES.focused.glowShadow,
            }}
            whileTap={{ scale: 0.98 }}
          >
            {/* Google logo SVG */}
        ...
        >
          Your data stays private. We only use your mood to personalize your
          experience.
        </motion.p>
      </motion.div>
    </FocusFade>
