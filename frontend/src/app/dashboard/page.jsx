...
export default function DashboardPage() {
  ...
  const fetchTracks = useCallback(async (moodParam) => {
    setTracksLoading(true);
    setMusicError(null);
    try {
      const res = await fetch(
        `${API}/api/playlists?mood=${moodParam}&limit=20`,
        {
          credentials: "include",
        },
      );
        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              <span className="text-2xl" role="img" aria-label="VibeFlow">
                🌊
              </span>
              <div>
                <h1
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <span
                  className={`${streakFlameSize} leading-none`}
                  role="img"
                  aria-label="streak"
                >
                  {streakEmoji}
            ...
            {!spotifyConnected && (
              <div className="text-center py-10">
                ...
                <p className="text-sm text-white/50 mb-2">
                  Connect Spotify to stream music matched to your mood
                </p>
                <p className="text-xs text-white/30 mb-5">
                  Works with free & premium accounts
                </p>
                <motion.button
          ...
          >
            <div>
              ...
              <p className="text-xs text-white/40 mt-0.5">
                Constellation chart + Energy waves
              </p>
            </div>
            <motion.button
              id="analytics-btn"
