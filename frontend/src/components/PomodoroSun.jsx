 ...
 */
export default function PomodoroSun({ theme, onSessionComplete }) {
  ...
  const tick = useCallback(() => {
    ...
    if (remaining === 0) {
      ...
      setTimeout(
        () => setIsPulsing(false),
        DURATION.POMODORO_PULSE * 3 * 1000 + 200,
      );
    }
  ...
  const handlePlayPause = useCallback(() => {
    if (isRunning) {
      ...
      startTimeRef.current =
        Date.now() - (totalRef.current - secondsLeft) * 1000;
    ...
    <div className="flex flex-col items-center gap-6">
      ...
      >
        ...
        <div
          ...
          style={{
            boxShadow: `0 0 ${glowBlur * 2}px ${theme.color}${Math.round(
              glowOpacity * 255,
            )
              .toString(16)
              .padStart(2, "0")}`,
      ...
      <div className="flex items-center gap-4">
        ...
        <motion.button
          ...
          whileHover={
            secondsLeft > 0 ? { scale: 1.08, boxShadow: theme.glowShadow } : {}
          }
