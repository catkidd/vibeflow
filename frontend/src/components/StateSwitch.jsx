 ...
 */
export default function StateSwitch({ isTransitioning, moodColor, children }) {
  return (
    <>
 ...
 */
export function DashboardEntrance({ children }) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{
        ...
        delay: DURATION.CIRCLE_WIPE + 0.1,
      }}
    >
      {children}
    </motion.div>
