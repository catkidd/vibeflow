 ...
 */
export const questionnaireContainerVariants = {
  hidden: {},
  visible: {
    transition: {
      staggerChildren: DURATION.STAGGER_CARD,
 ...
 */
export const moodEntryCollapseVariants = {
 ...
 */
export const circleWipeVariants = {
 ...
 */
export const dashboardExpandVariants = {
 ...
 */
export const taskCompletionVariants = {
 ...
 */
export const bubblePopVariants = {
 ...
 */
export const pomodoroCompleteVariants = {
  idle: { scale: 1 },
  pulsing: {
 ...
 */
export const playlistCardVariants = {
  idle: { height: "auto" },
  hovered: {
    height: "auto",
 ...
 * Mini player collapse to circle.
 */
export const miniPlayerVariants = {
