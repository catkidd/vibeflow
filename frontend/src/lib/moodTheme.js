...
export const MOOD_THEMES = {
  happy: {
    ...
    glowShadow:
      "0 0 20px rgba(255, 209, 102, 0.80), 0 0 40px rgba(255, 209, 102, 0.40)",
    subtleGlow: "0 0 12px rgba(255, 209, 102, 0.50)",
    strongGlow:
      "0 0 32px rgba(255, 209, 102, 0.90), 0 0 60px rgba(255, 209, 102, 0.50)",
    backgroundBleed:
      "radial-gradient(ellipse at center, rgba(255, 209, 102, 0.10) 0%, #1A1A2E 70%)",
    sliderGradient:
      "linear-gradient(90deg, rgba(255, 209, 102, 0.20), rgba(255, 209, 102, 1))",
    flameGradient:
      "linear-gradient(180deg, #FFE566 0%, #FFD166 40%, #FF9A3C 100%)",
    label: "Happy",
    emoji: "😄",
  },
  energetic: {
    ...
    glowShadow:
      "0 0 20px rgba(255, 154, 60, 0.80), 0 0 40px rgba(255, 154, 60, 0.40)",
    subtleGlow: "0 0 12px rgba(255, 154, 60, 0.50)",
    strongGlow:
      "0 0 32px rgba(255, 154, 60, 0.90), 0 0 60px rgba(255, 154, 60, 0.50)",
    backgroundBleed:
      "radial-gradient(ellipse at center, rgba(255, 154, 60, 0.10) 0%, #1A1A2E 70%)",
    sliderGradient:
      "linear-gradient(90deg, rgba(255, 154, 60, 0.20), rgba(255, 154, 60, 1))",
    flameGradient:
      "linear-gradient(180deg, #FFCF6B 0%, #FF9A3C 40%, #FF5E3A 100%)",
    label: "Energetic",
    emoji: "⚡",
  },
  calm: {
    ...
    glowShadow:
      "0 0 20px rgba(116, 192, 168, 0.80), 0 0 40px rgba(116, 192, 168, 0.40)",
    subtleGlow: "0 0 12px rgba(116, 192, 168, 0.50)",
    strongGlow:
      "0 0 32px rgba(116, 192, 168, 0.90), 0 0 60px rgba(116, 192, 168, 0.50)",
    backgroundBleed:
      "radial-gradient(ellipse at center, rgba(116, 192, 168, 0.10) 0%, #1A1A2E 70%)",
    sliderGradient:
      "linear-gradient(90deg, rgba(116, 192, 168, 0.20), rgba(116, 192, 168, 1))",
    flameGradient:
      "linear-gradient(180deg, #A8E6D9 0%, #74C0A8 40%, #3A8C75 100%)",
    label: "Calm",
    emoji: "😌",
  },
  stressed: {
    ...
    glowShadow:
      "0 0 20px rgba(255, 107, 107, 0.80), 0 0 40px rgba(255, 107, 107, 0.40)",
    subtleGlow: "0 0 12px rgba(255, 107, 107, 0.50)",
    strongGlow:
      "0 0 32px rgba(255, 107, 107, 0.90), 0 0 60px rgba(255, 107, 107, 0.50)",
    backgroundBleed:
      "radial-gradient(ellipse at center, rgba(255, 107, 107, 0.10) 0%, #1A1A2E 70%)",
    sliderGradient:
      "linear-gradient(90deg, rgba(255, 107, 107, 0.20), rgba(255, 107, 107, 1))",
    flameGradient:
      "linear-gradient(180deg, #FF9E9E 0%, #FF6B6B 40%, #CC2929 100%)",
    label: "Stressed",
    emoji: "😰",
  },
  sad: {
    ...
    glowShadow:
      "0 0 20px rgba(74, 88, 153, 0.80), 0 0 40px rgba(74, 88, 153, 0.40)",
    subtleGlow: "0 0 12px rgba(74, 88, 153, 0.50)",
    strongGlow:
      "0 0 32px rgba(74, 88, 153, 0.90), 0 0 60px rgba(74, 88, 153, 0.50)",
    backgroundBleed:
      "radial-gradient(ellipse at center, rgba(74, 88, 153, 0.10) 0%, #1A1A2E 70%)",
    sliderGradient:
      "linear-gradient(90deg, rgba(74, 88, 153, 0.20), rgba(74, 88, 153, 1))",
    flameGradient:
      "linear-gradient(180deg, #8A9ADF 0%, #4A5899 40%, #1E2A66 100%)",
    label: "Sad",
    emoji: "😢",
  },
  focused: {
    ...
    glowShadow:
      "0 0 20px rgba(155, 114, 207, 0.80), 0 0 40px rgba(155, 114, 207, 0.40)",
    subtleGlow: "0 0 12px rgba(155, 114, 207, 0.50)",
    strongGlow:
      "0 0 32px rgba(155, 114, 207, 0.90), 0 0 60px rgba(155, 114, 207, 0.50)",
    backgroundBleed:
      "radial-gradient(ellipse at center, rgba(155, 114, 207, 0.10) 0%, #1A1A2E 70%)",
    sliderGradient:
      "linear-gradient(90deg, rgba(155, 114, 207, 0.20), rgba(155, 114, 207, 1))",
    flameGradient:
      "linear-gradient(180deg, #C8A8EF 0%, #9B72CF 40%, #5A2E9C 100%)",
    label: "Focused",
    emoji: "🎯",
  },
};
 ...
 */
export function getMoodTheme(category) {
  return MOOD_THEMES[category] ?? MOOD_THEMES.focused;
}
 ...
 */
export function interpolateMoodGradient(moodA, moodB) {
 ...
 */
export function scoreToMoodCategory(composite, productivity, q3Raw) {
